...
def calculate_discount_percentage(
    current_price: Optional[float], msrp: Optional[float]
) -> Optional[float]:
    """
...
def calculate_price_difference(
    current_price: Optional[float], lowest_price: Optional[float]
) -> Optional[float]:
    """
...
def get_price_analysis_summary(
    ...
    return {
        "price_data": {
            ...
            "difference_vs_lowest": calculate_price_difference(
